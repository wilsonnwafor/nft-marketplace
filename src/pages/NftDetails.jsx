  ...
  return (
    <>
      <div className="mt-24 md:px-8">
        <div className="flex items-center w-10/12 mx-auto h-80">
          <div className="border border-gray-400 p-4 rounded-md h-80 w-2/6">
            <img className="h-full w-full rounded-md" src={`.${nft.image}`} alt={nft.name} />
          </div>
          <div className="h-full w-10/12 flex flex-col justify-end px-8">
            <div className="w-2/6 h-4/6 flex flex-col justify-between">
            ...
            <div className="w-full">
              <div className="w-full flex items-center justify-center gap-6 my-4">
                ...
                <Button className='w-2/4 flex items-center justify-center gap-6 bg-gray-600 hover:bg-gray-500'>
